    ...
    with tf.device("/gpu:0"):
        ...
        with tf.Graph().as_default():
            ...
            with tf.variable_scope("cifar_conv_model"):
                ...
                is_train = tf.placeholder(tf.float32) # mnist data image of shape 28*28=784
                keep_prob = tf.placeholder(tf.float32) # dropout probability

                x, y = tf.cond(is_train > 0, distorted_inputs, inputs)
                ...
                for epoch in range(training_epochs):
                    ...
                    if epoch % display_step == 0:
                        ...
                        accuracy = sess.run(eval_op, feed_dict={is_train: -1, keep_prob: 1})
